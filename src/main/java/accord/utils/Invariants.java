...
public class Invariants
{
    ...
    private static String format(String fmt, Object ... args)
    {
        ...
        {
            Object arg = args[i];
            if (arg instanceof Object[])        args[i] = Arrays.deepToString((Object[]) arg);
            else if (arg instanceof byte[])     args[i] = Arrays.toString((byte[])   arg);
            else if (arg instanceof short[])    args[i] = Arrays.toString((short[])  arg);
            else if (arg instanceof int[])      args[i] = Arrays.toString((int[])    arg);
            else if (arg instanceof long[])     args[i] = Arrays.toString((long[])   arg);
            else if (arg instanceof float[])    args[i] = Arrays.toString((float[])  arg);
            else if (arg instanceof double[])   args[i] = Arrays.toString((double[]) arg);
            else if (arg instanceof boolean[])  args[i] = Arrays.toString((boolean[])arg);
            else if (arg instanceof char[])     args[i] = Arrays.toString((char[])   arg);
        }
