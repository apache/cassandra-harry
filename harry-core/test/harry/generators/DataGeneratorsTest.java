...
import static harry.generators.Bijections.Bijection;
...
public class DataGeneratorsTest
{
    ...
    public static <T extends Comparable> void testOrderPreserving(Bijection<T> gen, Comparator<T> comparator)
    {
        test(gen, gen,
    ...
    public static <T1> void test(Bijection<T1> gen1,
    ...
    public static <T1, T2> void test(Bijection<T1> gen1,
                                     Bijection<T2> gen2,
