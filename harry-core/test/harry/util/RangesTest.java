...
public class RangesTest
{
    ...
    {
        List<Ranges.Range> list = Arrays.asList(inclusiveRange(10, 20, 10),
                                                inclusiveRange(40, 50, 10),
                                                inclusiveRange(60, 70, 10),
                                                inclusiveRange(80, 90, 10));
        Collections.shuffle(list);
        Ranges ranges = new Ranges(list);
    ...
    private void _randomizedRangesTest()
    {
        ...
        for (int i = 0; i < 100; i++)
        {
            ...
            Ranges.Range range = new Ranges.Range(Math.min(a, b),
                                                  Math.max(a,b),
                                                  rnd.nextBoolean(),
                                                  rnd.nextBoolean(),
                                                  rnd.nextInt(1000));
    ...
    public boolean matchLinear(List<Ranges.Range> ranges, long descriptor, long ts)
    {
    ...
    public Ranges.Range inclusiveRange(long start, long end, long ts)
    {
        return new Ranges.Range(start, end, true, true, 10);
    }
}
