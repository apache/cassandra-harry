...
public class NamedThreadFactory implements ThreadFactory
{
    ...
    {
        this(id, Thread.NORM_PRIORITY, contextClassLoader, threadGroup, (t, e) -> e.printStackTrace());
    }

    public NamedThreadFactory(String id, int priority, ClassLoader contextClassLoader, ThreadGroup threadGroup)
    {
        this(id, priority, contextClassLoader, threadGroup, (t, e) -> e.printStackTrace());
    }
